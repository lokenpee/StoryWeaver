...
5) 最后判断 will_complete_this_turn：只看你这回合给演员的框架是否会把当前节拍推进到结尾，不要和“这一拍未来还能不能继续扩写”混淆。
...
14) 本回合耗尽判定：will_complete_this_turn 表示你给演员的本回合 direction_script 是否会把当前节拍剧情推进到耗尽/结尾，并用 beat_complete_reason 简要说明判断依据。不要因为当前节拍未来还有细节可写就机械设为 false，重点判断本回合框架是否已经覆盖到当前节拍的结尾事件。
